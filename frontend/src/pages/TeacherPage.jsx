      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        ...
        >
          ...
          <p className="text-on-surface-variant max-w-md font-label text-base">
            Manage your daily tasks and track class-wide academic performance.
          </p>
        </motion.div>
          ...
          <section className="glass-panel p-8 rounded-[2.5rem] border border-outline-variant/15 overflow-hidden">
            <div className="flex items-center justify-between mb-8">
              <div className="space-y-1">
                ...
                <p className="text-xs text-on-surface-variant font-label uppercase tracking-widest leading-none">
                  ...
                  {STUDENT_DATA.map((student) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-5 first:rounded-l-2xl last:rounded-r-2xl">
                          <span
                            className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border ${status.border} ${status.text} ${status.bg}`}
                          >
                            {status.label}
                          </span>
                        </td>
