        ...
        <div className="relative z-10 flex flex-col justify-between p-20 w-full h-full">
          ...
          >
            <div className="w-12 h-12 rounded-2xl bg-secondary flex items-center justify-center shadow-2xl shadow-secondary/40 ring-4 ring-secondary/10">
              <span className="material-symbols-outlined text-surface-container-lowest text-2xl font-bold" data-icon="hub">hub</span>
            </div>
            <span className="text-3xl font-black text-white tracking-tight font-headline">ALWS</span>
          </motion.div>
          ...
          <div className="space-y-8 mt-auto mb-12">
            ...
            >
              <h1 className="text-7xl font-black text-white leading-[0.9] font-headline tracking-tighter">
                Master your <br />
                <span className="bg-gradient-to-r from-secondary via-tertiary to-secondary bg-clip-text text-transparent drop-shadow-2xl animate-gradient-x">future.</span>
              </h1>
            ...
            >
              The world's first adaptive learning and wellbeing system designed specifically for the next generation of achievers.
            </motion.p>
          </div>
      ...
      <div className="w-full lg:w-[55%] flex flex-col bg-transparent relative z-10 overflow-y-auto custom-scrollbar">
        ...
        <div className="flex justify-between items-center p-8">
          <div className="lg:hidden flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-secondary flex items-center justify-center">
               <span className="material-symbols-outlined text-white text-lg" data-icon="hub">hub</span>
            </div>
             ...
             <AnimatePresence mode="wait">
              {isLogin ? (
                ...
                >
                  <div className="absolute -top-24 -right-24 w-48 h-48 bg-secondary/10 rounded-full blur-3xl group-hover:bg-secondary/20 transition-all duration-700" />
                    ...
                    <div className="space-y-2 relative z-10">
                      <h2 className="text-5xl font-black text-white font-headline tracking-tighter">Sign In</h2>
                      <p className="text-on-surface-variant font-medium text-lg">Access your personalized learning dashboard.</p>
                    </div>
                    ...
                    <form onSubmit={handleAuth} className="relative z-10 space-y-5">
                      <div className="space-y-2">
                        ...
                        <div className="group relative">
                          ...
                          />
                          <span className="material-symbols-outlined absolute right-5 top-1/2 -translate-y-1/2 text-on-surface-variant/40 group-focus-within:text-secondary transition-colors text-[20px]" data-icon="mail">mail</span>
                        </div>
                      </div>

                      <div className="space-y-2">
                        <div className="flex justify-between items-center px-1">
                          <label className="text-[12px] font-bold text-on-surface-variant uppercase tracking-wider block" htmlFor="password">Password</label>
                        ...
                        <div className="group relative">
                          ...
                          />
                          <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-5 top-1/2 -translate-y-1/2 text-on-surface-variant/40 hover:text-white transition-colors">
                ...
                >
                  ...
                  <div className="space-y-2 relative z-10">
                    <h2 className="text-5xl font-black text-white font-headline tracking-tighter">Join ALWS</h2>
                    <p className="text-on-surface-variant font-medium text-lg">Empower your student journey today.</p>
                  </div>
                  ...
                  <div className="flex flex-col items-center gap-4 py-2 relative z-10">
                    ...
                    >
                      {profilePic ? (
                        ...
                        <div className="flex flex-col items-center gap-2">
                          <span className="material-symbols-outlined text-on-surface-variant/40 group-hover/pic:text-secondary text-4xl transition-colors" data-icon="add_a_photo">add_a_photo</span>
                        </div>
                      )}
                    ...
                    <span className="text-[10px] font-black text-on-surface-variant/30 uppercase tracking-[0.2em]">Optional Profile Photo</span>
                  ...
                  <form onSubmit={handleAuth} className="space-y-4 relative z-10">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[11px] font-bold text-on-surface-variant uppercase tracking-wider block ml-1">First Name</label>
                        <input 
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[11px] font-bold text-on-surface-variant uppercase tracking-wider block ml-1">Last Name</label>
                        <input 
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-bold text-on-surface-variant uppercase tracking-wider block ml-1">Email Address</label>
                      <input 
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-bold text-on-surface-variant uppercase tracking-wider block ml-1">Course / Branch</label>
                      <input 
                        required type="text" value={courseBranch} onChange={(e) => setCourseBranch(e.target.value)}
                        className="w-full px-5 py-3.5 bg-surface-container-high/40 border border-outline-variant/30 rounded-xl focus:ring-4 focus:ring-secondary/10 focus:border-secondary transition-all text-white font-medium text-sm placeholder:text-white/10"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-bold text-on-surface-variant uppercase tracking-wider block ml-1">Assign Password</label>
                      <input 
                  ...
                  <div className="flex flex-col items-center gap-4 mt-8 relative z-10">
                    <span className="text-[10px] font-black text-on-surface-variant/30 uppercase tracking-[0.3em]">Or Register Faster Using</span>
                    <div className="flex gap-4 w-full">
                       <button className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-white/5 border border-outline-variant/20 hover:bg-white/10 transition-all backdrop-blur-sm">
                          ...
                          <span className="text-xs font-bold text-white/80">Google</span>
                       </button>
                       <button className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-white hover:bg-white/90 transition-all">
                          <svg className="w-4 h-4 fill-black" viewBox="0 0 24 24"><path d="M17.05 20.28c-.96.95-2.3 1.72-3.73 1.72-1.43 0-2.45-.6-3.41-.6s-2.03.6-3.41.6c-1.43 0-2.77-.77-3.73-1.72C1.43 18.23 0 15.11 0 12.04c0-3.07 1.48-6.19 2.77-7.14C4.1 3.95 5.58 3.23 7.01 3.23c1.43 0 2.45.6 3.41.6s2.03-.6 3.41-.6c1.43 0 2.91.72 4.24 1.67 1.29.95 2.77 4.07 2.77 7.14 0 3.07-1.43 6.19-3.79 8.24zM12 3c0-1.61.64-3 1.61-3.97.97-.97 2.36-1.61 3.97-1.61.12 1.61-.52 3-1.49 4.1-.97.97-2.36 1.61-3.97 1.61-.12-1.61-.12-1.61-.12-1.61z"/></svg>
        ...
        <div className="p-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-[13px] text-on-surface-variant/40 font-medium relative z-10">
          ...
          <div className="flex items-center gap-2 cursor-pointer hover:text-secondary transition-colors group">
            <span className="material-symbols-outlined text-sm group-hover:rotate-12 transition-transform" data-icon="language">language</span>
