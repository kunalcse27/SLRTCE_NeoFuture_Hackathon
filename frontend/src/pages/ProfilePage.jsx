...
export default function ProfilePage() {
  ...
  const handleSave = () => {
    try {
      ...
      const storageLayer = localStorage.getItem("alws_session")
        ? localStorage
        : sessionStorage;
      ...
      <div className="max-w-5xl mx-auto">
          ...
          <AnimatePresence mode="popLayout">
            {isEditing ? (
              ...
              >
                ...
                >
                  <span
                    className="material-symbols-outlined font-black text-sm"
                    data-icon="save"
                  >
                    save
                  </span>
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-8">
            <motion.div
              layout
              className="glass-panel p-10 rounded-[3.5rem] border border-white/5 bg-[#1a1a1a]/60 space-y-12"
            >
              {/* Account Credentials */}
              <section className="space-y-6">
                ...
                <p className="text-[10px] text-slate-500 italic ml-2">
                  These are your primary login credentials used for site access.
                </p>
              </section>
